        ...
        if (global_cgb)
        {
            switch (a)
            {
                case 0xFF4D: 
                    ...
                    /* wanna go double speed? */
                    if (v & 0x01)
                    {
                        global_double_speed = 1;
                        cycles_clock = 4194304 * 2;
                    ...
                    else
                    {
                        ...
                        /* save into memory i'm working at normal speed */
                        memory[a] = 0x00;
                    }
